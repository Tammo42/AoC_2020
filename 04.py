...
class PassportValidator:
    def __init__(self, fields=["byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid", "cid"], optionals=["cid"]):
        self.fields = fields
...
class PassportValidator2:
    ...
    def check_byr(self, value):
        return len(value) == 4 \
            and 1919 < int(value) \
            and int(value) < 2003

    def check_iyr(self, value):
        return len(value) == 4 \
            and 2009 < int(value) \
            and int(value) < 2021

    def check_eyr(self, value):
        return len(value) == 4 \
            and 2019 < int(value) \
            and int(value) < 2031

    def check_hgt(self, value):
        valid = True
        value.lstrip("0")
